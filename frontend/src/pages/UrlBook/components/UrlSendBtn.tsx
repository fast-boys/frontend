...
export const UrlSendBtn = () => {
  ...
  const { urls, selectAllUrls, unSelectAllUrls } = useUrlStore((state) => ({ urls: state.urls, selectAllUrls: state.selectAllUrls, unSelectAllUrls: state.unSelectAllUrls }));
  ...
  return (
    <div>
      {urls.length === 0 ? (
        ...
        <div className="flex justify-end"> {/* justify-end를 사용하여 오른쪽 정렬 */}
        <button
